    ...
    , ui(new Ui::MainWindow)
{
    ...
    editor->setWhitespaceVisibility(QsciScintilla::WsInvisible);//此时空格不显示
    editor->setWhitespaceSize(4);//空格点大小

    //indent
    editor->setIndentationsUseTabs(false);//false用表示用空格代替\t
    editor->setTabWidth(8);//\t宽度设为8个空格
    ...
    editor->setCaretLineBackgroundColor(QColor(41,47,68));//光标所在行背景颜色
    ...
    margin_font.setPointSize(16);//边栏字体设置px我这里显示不出行号，不知道是怎么回事
